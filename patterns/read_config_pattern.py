...
class ReadConfigPattern:
    ...
    def check_database_existence(self):
        ...
        check_for_database_builder: dict[str, str] = {
            ...
            "file_type": "FASTQ",  # FIX THIS AS INPUT
        }
    ...
    def create_database_from_config(self):
        ...
        Fill in later...
        """
        print("Creating database from configuration")
        # Create the database
        # Check if the database exists
        ...
        make_database_builder: dict[str, str] = {
            ...
            "database_type": "pass",  # FIX THIS AS INPUT
        }
...
if __name__ == "__main__":
    pattern = ReadConfigPattern(
        "/Users/mvandestreek/Developer/pacini_typing/patterns/O1.yaml"
    )
    pattern.run_config()
